Feature:Story: As a user, I should be able to write comments to files/folders.

  Scenario:Verify users to write comments to files/folderTE

    Given user on the dashboard pageTE
